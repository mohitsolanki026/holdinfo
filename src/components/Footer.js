      ...
      <table>
        ...
        <tbody>
          <tr className="tableRaw">
            ...
            <td>
              <h2>₹ {selectedCryptoData ? selectedCryptoData.value.last : ''}</h2>
            </td>
            <td>
              <h2>₹ {selectedCryptoData ? selectedCryptoData.value.buy : ''} / ₹ {selectedCryptoData ? selectedCryptoData.value.sell : ''}</h2>
            </td>
            <td>
              <h2 style={{ color: 'rgb(255, 67, 67)' }}>-9.41 %</h2>
            </td>
            <td>
              <h2 style={{ color: 'rgb(255, 67, 67)' }}>▼ ₹ 2,36,251</h2>
            </td>
          </tr>
        </tbody>
      </table>
